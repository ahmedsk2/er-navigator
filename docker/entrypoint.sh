...
set -eu
KEEP=" DATABASE_URL APP_URL APP_TIMEZONE REPORT_HEADER AUTH_SECRET AUTH_TRUST_HOST SMTP_HOST SMTP_PORT SMTP_USER SMTP_PASSWORD SMTP_FROM ALERT_INTERVAL_MINUTES ALERT_HEARTBEAT_FILE LOG_LEVEL NODE_ENV NODE_OPTIONS PORT HOSTNAME SOURCE_COMMIT PATH HOME TZ NEXT_TELEMETRY_DISABLED "
