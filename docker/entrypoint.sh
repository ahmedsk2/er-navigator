...
set -eu
KEEP=" DATABASE_URL APP_URL REPORT_HEADER INSTANCE_LABEL SMTP_HOST SMTP_PORT SMTP_USER SMTP_PASSWORD SMTP_FROM ALERT_INTERVAL_MINUTES ALERT_HEARTBEAT_FILE ALERT_PUSH_URL NODE_ENV NODE_OPTIONS PORT HOSTNAME SOURCE_COMMIT PATH HOME TZ NEXT_TELEMETRY_DISABLED "
