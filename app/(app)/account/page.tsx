...
export default async function AccountPage() {
  ...
  return (
    <div className="px-4 pt-6 pb-6">
      ...
      {/* Phase 9: the two blocks become cards, so the page reads as two things and not as one
          long strip of hairlines. The headings, the copy and the form are untouched. */}
      <dl className="mt-3 divide-y divide-line-soft rounded-card border border-line bg-panel px-4 shadow-card">
      ...
      <section className="mt-6 rounded-card border border-line bg-panel p-4 shadow-card">
